...
func TestAllPermissions_MapIntegrity(t *testing.T) {
	...
	all := []Permission{
		...
		PermissionSchedulesCreate, PermissionSchedulesRead, PermissionSchedulesUpdate, PermissionSchedulesDelete,
		PermissionCalendarEventsCreate, PermissionCalendarEventsRead,
		PermissionCalendarEventsUpdate, PermissionCalendarEventsDelete,
		PermissionAnnouncementsCreate, PermissionAnnouncementsRead,
		PermissionAnnouncementsUpdate, PermissionAnnouncementsDelete,
		PermissionColorsCreate, PermissionColorsRead,
		PermissionColorsUpdate, PermissionColorsDelete,
